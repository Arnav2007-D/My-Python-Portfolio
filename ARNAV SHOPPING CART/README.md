...
Simple console app to add grocery items with prices and calculate total.

## Features
- Add unlimited grocery items with prices
- View complete cart with individual prices
